...
CTE-s_Mini_Project.sql

Contains all the CTE-based queries for the business questions listed above.
​

🚀 How to Use
Import or connect to the Adventure Works sales dataset in your SQL environment.
​

Make sure the tables factsales and dimsalesterritory (or equivalent) exist with the required columns.
​

Run the script CTE-s_Mini_Project.sql section by section to explore each analysis.
​
